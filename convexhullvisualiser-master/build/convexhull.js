    ...
    new Vue({
        ...
        methods: {
            upload: function(a) {
                ...
                b.onload = function(a) {
                    d.clear();
                    for (var b = a.target.result, c = b.match(/[0-9]+/g), e = 0; e < c.length; e += 2) d.points.push([parseInt(c[e]), parseInt(c[e + 1])]);
                    d.start();
                }, b.readAsText(c);
            },
            ...
            addPoints: function() {
                ...
                for (var b, c, d = this, e = 0; e < parseInt(this.countString);) b = Math.floor(100 * Math.random()), c = Math.floor(100 * Math.random()), a(b, c) || (this.points.push([b, c]), e += 1);
                this.start();
            },
            plot: function() {
                var a, c, d, h;
                if (this.stateIndexString = "" + this.currentStateIndex, h = i[this.algorithm], b.plot(this.points, h, {
                        marker: g
                    }, !0), this.states.length > 0) {
                    a = this.states[this.currentStateIndex];
                    c = a.lines;
                    b.plot(a.hull, "lines+markers", {
                        line: e,
                        marker: f
                    });
                    for (var j = 0; j < c.length; j++) d = c[j], b.plot(d.points, "lines", {
                        line: d.style
                    });
                }
            }
